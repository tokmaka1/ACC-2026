...
# Make sure MuJoCo uses the on-screen GLFW backend
os.environ.setdefault("MUJOCO_GL", "glfw")

# Ensure the MuJoCo binaries are on the loader path (adjust the path if yours differs)
ld = os.environ.get("LD_LIBRARY_PATH", "")
mujoco_bin = "/u/08/tokmaka1/unix/.mujoco/mujoco200/bin"
